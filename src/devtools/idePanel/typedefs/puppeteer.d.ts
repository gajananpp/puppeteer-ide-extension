declare namespace puppeteer {
   ...
   */
  type LiteralUnion<LiteralType> =
    | LiteralType
    | (string & {_?: never | undefined});
  ...
  export interface Keyboard {
    ...
    press(
      key: string,
      options?: {text?: string | undefined; delay?: number | undefined}
    ): Promise<void>;
  ...
  export interface CustomQueryHandler {
    queryOne?:
      | ((element: Element | Document, selector: string) => Element | null)
      | undefined;
    queryAll?:
      | ((
